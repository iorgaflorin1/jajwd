/*
 * Testing codes used in training
 */
...
public class TestCodes {
    ...
    public static void main(String[] args) {
        ...
        System.err.println("After append StringBuilder content is: "+sb);
        sb.ensureCapacity(255); //Ensures that the capacity is at least equal to the specified minimum.
        sb.append(25);
        System.err.println("After append 25 content is: "+sb);
        sb.delete(17, 19);
        System.err.println("After deleteing from index 17 to 19 content is: "+sb);
        //
        System.out.println("-------------------------------------------------------------------------");
        // DayOFWeen and Moth Enums
        DayOfWeek dow = DayOfWeek.MONDAY;
        Month month = Month.MAY;
        Locale locale = Locale.getDefault();
        System.out.println(dow.getDisplayName(TextStyle.FULL, locale));
        System.out.println(month.getDisplayName(TextStyle.FULL, locale));
        // LocalDate, YearMounth classes
